defmodule OwensBlogWeb.CoreComponents do
  @moduledoc """
  ...
  attr :value, :any
  attr :class_inject, :string, default: ""
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OwensBlogWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OwensBlogWeb.Gettext, "errors", msg, opts)
    end
  end
